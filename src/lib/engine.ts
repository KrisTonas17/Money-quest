...
import lesson3 from "../../data/lessons/lesson-3.json";
import lesson4 from "../../data/lessons/lesson-4.json";
import lesson5 from "../../data/lessons/lesson-5.json";
import lesson6 from "../../data/lessons/lesson-6.json";
import lesson7 from "../../data/lessons/lesson-7.json";
import lesson8 from "../../data/lessons/lesson-8.json";

// Lesson pack lookup (static imports keep Next.js bundling happy)
...
export function generateBossChallenge(week: number, seed: string) {
  ...
  // Reality Remix forecast based on rules
